...
//
// The host compiler is MSVC for the Phase 21 proof, so this file emits the
// assembler include syntax consumed by the host-side NativeAOT assembler. It
// contains no Windows target or API dependency.
