#!/usr/bin/env python3
"""Build a fixed-base GXMI descriptor for a Phase 28 SDK payload."""
...
def main() -> int:
    ...
    parser.add_argument("mode", choices=sorted(PHASE28_FLAGS))
    ...
    flags |= PHASE26_FLAG | PHASE28_FLAGS[args.mode]
