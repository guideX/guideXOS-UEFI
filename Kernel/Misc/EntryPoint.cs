...
#endif
#if UEFI_DIAGNOSTIC_RING3_PHASE27
            if (BootConsole.CurrentMode == guideXOS.BootMode.UEFI) {
                Ring3Proof.SchedulePhase27();
                BootConsole.WriteLine("PHASE27_QUEUED_FOR_SCHEDULER=1");
            }
#endif
#if UEFI_DIAGNOSTIC_RING3_PHASE28
            if (BootConsole.CurrentMode == guideXOS.BootMode.UEFI) {
                Ring3Proof.SchedulePhase28();
                BootConsole.WriteLine("PHASE28_QUEUED_FOR_SCHEDULER=1");
            }
#endif
#if UEFI_DIAGNOSTIC_RING3_PHASE29
            if (BootConsole.CurrentMode == guideXOS.BootMode.UEFI) {
                Ring3Proof.SchedulePhase29();
...
#if UEFI_DIAGNOSTIC_RING3 || UEFI_DIAGNOSTIC_RING3_DIRECT || UEFI_DIAGNOSTIC_RING3_PHASE15 || UEFI_DIAGNOSTIC_RING3_PHASE24 || UEFI_DIAGNOSTIC_RING3_PHASE25 || UEFI_DIAGNOSTIC_RING3_PHASE26 || UEFI_DIAGNOSTIC_RING3_PHASE27 || UEFI_DIAGNOSTIC_RING3_PHASE28
            if (BootConsole.CurrentMode == guideXOS.BootMode.UEFI)
